...
// ADR-026 Phase 3 added screenshot_query + screenshot_gc → 29 stub catalog
// entries. (Public surface = 29 stub + 2 dynamic v2 = 31 tools.) The bound is
// kept tight so dropping either of the two new maintenance tools fails the build.
if (tools.length < 29) {
  throw new Error(`Expected at least 29 tools, generated ${tools.length}`);
}
