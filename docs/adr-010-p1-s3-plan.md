...
- **expansion**: ADR-010 §5.4 typed reason 49 codes (Phase 7 reconcile 後 = live 37 + ADR-added 12) 全網羅 (P2 expansion work)、`if_unexpected.most_likely_cause: "EnvelopeSizeExceeded"` typed enum stamp 等
